...
<section class="container">
    <form:form modelAttribute="newProduct" class="form-horizontal" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg2" for="name">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg2" for="unitPrice">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg2" for="manufacturer">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg2" for="category">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg2" for="unitsInStock">
